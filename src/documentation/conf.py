...
project = "Structural Behavioral Economics (Dellavigna, Pope 2018) using Estimagic"
copyright = "2019-, Edoardo Falchi, Nigar Valiyeva"
...
latex_documents = [
    (
        ...
        """Documentation of the Structural Behavioral Economics (Dellavigna, Pope 2018) using Estimagic project""",
        "Edoardo Falchi, Nigar Valiyeva",
        "manual",
    )
]
