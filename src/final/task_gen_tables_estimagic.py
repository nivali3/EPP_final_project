...
@pytask.mark.depends_on(
    {
        "nel_pow": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "benchmark_est_pow_estimagic_scipy_neldermead.yaml",
        "trf_pow": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "benchmark_est_pow_estimagic_scipy_ls_trf.yaml",
        "dog_pow": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "benchmark_est_pow_estimagic_scipy_ls_dogbox.yaml",
        "nel_exp": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "benchmark_est_exp_estimagic_scipy_neldermead.yaml",
        "trf_exp": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "benchmark_est_exp_estimagic_scipy_ls_trf.yaml",
        "dog_exp": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "benchmark_est_exp_estimagic_scipy_ls_dogbox.yaml",
    }
)
...
def task_estimagic_nls_benchmark(depends_on, produces):
    ...
    for i in comb:
        ...
        with open(depends_on[i]) as stream:
...
@pytask.mark.depends_on(
    {
        ...
        / "analysis"
        / "estimated_parameters_estimagic"
        / "no_weight_est_pow_estimagic_scipy_neldermead.yaml",
        "trf_pow": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "no_weight_est_pow_estimagic_scipy_ls_trf.yaml",
        "dog_pow": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "no_weight_est_pow_estimagic_scipy_ls_dogbox.yaml",
        "nel_exp": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "no_weight_est_exp_estimagic_scipy_neldermead.yaml",
        "trf_exp": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "no_weight_est_exp_estimagic_scipy_ls_trf.yaml",
        "dog_exp": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "no_weight_est_exp_estimagic_scipy_ls_dogbox.yaml",
    }
)
...
@pytask.mark.depends_on(
    {
        ...
        / "analysis"
        / "estimated_parameters_estimagic"
        / "prob_weight_lin_curv_est_pow_estimagic_scipy_neldermead.yaml",
        "trf_pow": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "prob_weight_lin_curv_est_pow_estimagic_scipy_ls_trf.yaml",
        "dog_pow": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "prob_weight_lin_curv_est_pow_estimagic_scipy_ls_dogbox.yaml",
        "nel_exp": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "prob_weight_lin_curv_est_exp_estimagic_scipy_neldermead.yaml",
        "trf_exp": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "prob_weight_lin_curv_est_exp_estimagic_scipy_ls_trf.yaml",
        "dog_exp": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "prob_weight_lin_curv_est_exp_estimagic_scipy_ls_dogbox.yaml",
    }
)
...
@pytask.mark.depends_on(
    {
        ...
        / "analysis"
        / "estimated_parameters_estimagic"
        / "prob_weight_conc_curv_est_pow_estimagic_scipy_neldermead.yaml",
        "trf_pow": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "prob_weight_conc_curv_est_pow_estimagic_scipy_ls_trf.yaml",
        "dog_pow": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "prob_weight_conc_curv_est_pow_estimagic_scipy_ls_dogbox.yaml",
        "nel_exp": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "prob_weight_conc_curv_est_exp_estimagic_scipy_neldermead.yaml",
        "trf_exp": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "prob_weight_conc_curv_est_exp_estimagic_scipy_ls_trf.yaml",
        "dog_exp": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "prob_weight_conc_curv_est_exp_estimagic_scipy_ls_dogbox.yaml",
    }
)
...
@pytask.mark.depends_on(
    {
        ...
        / "analysis"
        / "estimated_parameters_estimagic"
        / "prob_weight_est_curv_est_pow_estimagic_scipy_neldermead.yaml",
        "trf_pow": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "prob_weight_est_curv_est_pow_estimagic_scipy_ls_trf.yaml",
        "dog_pow": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "prob_weight_est_curv_est_pow_estimagic_scipy_ls_dogbox.yaml",
        "nel_exp": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "prob_weight_est_curv_est_exp_estimagic_scipy_neldermead.yaml",
        "trf_exp": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "prob_weight_est_curv_est_exp_estimagic_scipy_ls_trf.yaml",
        "dog_exp": BLD
        / "analysis"
        / "estimated_parameters_estimagic"
        / "prob_weight_est_curv_est_exp_estimagic_scipy_ls_dogbox.yaml",
    }
)
