...
def task_nls_probweight_behavioral(depends_on, produces):
    """Load non-linear-least-squares estimates of model on effort
    in three benchmark treatments and two probability treatments
    (power and exponential cost function scenarios). Create a table
    that replicate Panel A of Table 6 of the paper.
    Save this in a csv file in `bld/tables`.
